...
/* harmony import */ var _updateForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./updateForm */ "./resources/js/updateForm.js");
...
(0,_updateForm__WEBPACK_IMPORTED_MODULE_1__.updateForm)();
/*---------------------------------
...
function updateForm() {
  ...
  $("#update_form").submit(function (event) {
    ...
    var request = {
      "url": "http://localhost:3500/university/certificate/update/".concat(data.id),
      "method": "PUT",
      "data": data
    };
  ...
  if (window.location.pathname == "/university/certificate/table") {
    ...
    $ondelete.click(function () {
      ...
      var request = {
        "url": "http://localhost:3500/university/certificate/delete/".concat(id),
        "method": "DELETE"
      };
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmuhtasim"] = self["webpackChunkmuhtasim"] || [];
